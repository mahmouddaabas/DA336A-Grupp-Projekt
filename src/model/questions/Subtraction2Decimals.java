 ...
 */
public class Subtraction2Decimals extends MathQuestions {
     ...
     */
    public Subtraction2Decimals(double number1LowerBound, double number1UpperBound, int numOfDecimalsNumber1,
    ...
    /**
     * Generates the correct answer and 3 fake answers in the answer array. The answers are all unique. The number of
     * decimal places is automatically the bigger of the two numbers that are subtracted.
     */
